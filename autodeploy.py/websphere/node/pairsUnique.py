        ...
        for uniquenodeContainedServers in nodesContainedServers:
            ...
            if uniquenode == nodeName:
                ...
                if serverName != "":
                    ...
                    log(DEBUG_,
                        "determineUniqueNodesContainedServers: Replacing node=" + nodeName + " with NEW containedServers=" + `containedServers`)
                    del nodesContainedServers[nodeIndex]
                    nodesContainedServers.insert(nodeIndex, nodeContainedServers)
                    log(DEBUG_,
                        "determineUniqueNodesContainedServers: New nodesContainedServers=" + `nodesContainedServers`)
                    #endIf
                nodeName = ""
                break
                #endIf
