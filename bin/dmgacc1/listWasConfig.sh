LOGDATE=`date +%Y%m%d`
WAS_CELL=dmgacc1Network; export WAS_CELL
...
elif [ "$HOSTNAME" = "dmgacc1.mle.mazdaeur.com" ]  ; then
     WAS_CELL=dmgacc1Network; export WAS_CELL
...
xsltproc xslt/listDSLinda.xslt   ../../conf/$WAS_CELL/$WAS_CELL.xml > ../../conf/$WAS_CELL/listDSLinda.xml

xsltproc xslt/listClusterApplications_linda.xslt   ../../conf/$WAS_CELL/$WAS_CELL.xml > ../../conf/$WAS_CELL/listAPPLinda.xml
