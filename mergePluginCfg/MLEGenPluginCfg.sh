...
case $CLASS in 
	TSTHTTPS)  NODE="mappstmp.mazdaeur.com"
                  ...
                  CELL=dmgtst1Cell01
                  ;;
	ACCHTTP)  NODE="mappsacc.mle.mazdaeur.com"
                  WEBSERVER="webacc1"
	...
	PRDHTTP)  NODE="mapps.willebroek.mazdaeurope.com"
                  WEBSERVER="defrlpwe004"
                  SERVERS="defrlpwe004.mazdaeur.com defrlpwe005.mazdaeur.com"
                  CELL=PRDcell01
                  DMGR=PRDcell01
                  ;;
        PRDHTTPS) NODE="mapps.mazdaeur.com"
                  WEBSERVER="defrlpwe001"
                  SERVERS="defrlpwe001.mazdaeur.com defrlpwe002.mazdaeur.com defrlpwe003.mazdaeur.com"
                  CELL=PRDcell01
                  DMGR=PRDcell01
                  ;;
  ...
  cp /opt/IBM/WebSphere/AppServer/profiles/${DMGR}/config/cells/${CELL}/nodes/$NODE/servers/$WEBSERVER/plugin-cfg.xml /tmp/plugin-WAS6-$CLASS.xml
