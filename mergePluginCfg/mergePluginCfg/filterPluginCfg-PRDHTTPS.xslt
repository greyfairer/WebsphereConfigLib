<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/Config/UriGroup[@Name='default_host_ACCmum1_URIs']/Uri[@Name='/crsaxis/*']">
        <Uri AffinityCookie="JSESSIONID" AffinityURLIdentifier="jsessionid"
             Name="/crsaxis/services/MUMFederationUserDataService"/><xsl:text>
      </xsl:text>
        <Uri AffinityCookie="JSESSIONID" AffinityURLIdentifier="jsessionid"
             Name="/crsaxis/services/MUMFederationTicketService"/><xsl:text>
      </xsl:text>
        <Uri AffinityCookie="JSESSIONID" AffinityURLIdentifier="jsessionid"
             Name="/crsaxis/services/MUMFederationTicketChainService"/>
    </xsl:template>
    ...
    <xsl:template match="/Config/UriGroup[@Name='default_host_ACCmum1_URIs']/Uri[@Name='/crsxfire/*']">
        ...
        <Uri AffinityCookie="JSESSIONID" AffinityURLIdentifier="jsessionid"
             Name="/crsxfire/services/IoSubscriptionService"/><xsl:text>
      </xsl:text>
        <Uri AffinityCookie="JSESSIONID" AffinityURLIdentifier="jsessionid"
             Name="/crsxfire/services/MUMTicketIssuanceService"/>
    </xsl:template>
