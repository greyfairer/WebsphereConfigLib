<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
        ...
        <Cell name="{@name}" xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'
            ...
            <xsl:for-each select="ServerCluster">
                <ServerCluster name="{./@name}">
                    ...
                    <xsl:for-each
                            select="ServerConfig[Resources/JDBCProvider[@providerType='Oracle JDBC Driver' or @providerType='Oracle JDBC Driver (XA)' or @providerType='DB2 Legacy CLI-based Type 2 JDBC Driver' or @providerType='DB2 Legacy CLI-based Type 2 JDBC Driver (XA)']/DataSource]">
    ...
    <xsl:template match="JDBCProvider[@providerType='Oracle JDBC Driver']">
        <JDBCProvider providerType="Oracle JDBC Driver" databaseType="Oracle"
    ...
    <xsl:template match="JDBCProvider[@providerType='DB2 Legacy CLI-based Type 2 JDBC Driver' and @xa='false']">
        <JDBCProvider databaseType="DB2" providerType="DB2 Legacy CLI-based Type 2 JDBC Driver (Deprecated)"
                      implementationType="Connection pool data source"
                      name="DB2 Legacy CLI-based Type 2 JDBC Driver"
                      description="Deprecated - DB2 JDBC2-compliant Provider">
            <xsl:for-each select="DataSource">
                <DataSource>
                    <xsl:copy-of select="@*"/>
                    <ResourceProperties>
    ...
    <xsl:template match="JDBCProvider[@providerType='DB2 Legacy CLI-based Type 2 JDBC Driver (XA)' and @xa='true']">
        <JDBCProvider databaseType="DB2" providerType="DB2 Legacy CLI-based Type 2 JDBC Driver (Deprecated)"
                      ...
                      name="DB2 Legacy CLI-based Type 2 JDBC Driver (XA)"
                      description="Deprecated - DB2 JDBC2-compliant Provider">
            <xsl:for-each select="DataSource">
                <DataSource>
                    <xsl:copy-of select="@*"/>
