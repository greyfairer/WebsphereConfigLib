class AdminConfigClass:
    ...
    def withComplex(self, attributeName, attributeClass):
        self.attributes.append(
            AdminConfigAttribute(attributeName, AdminConfigAttribute.complexAttribute, attributeClass))
        return self

    def withList(self, attributeName, attributeClass):
        self.attributes.append(
            AdminConfigAttribute(attributeName, AdminConfigAttribute.listAttribute, attributeClass, parentName=None))
        return self
    ...
    def simpleAttributes(self):
        return filter(lambda attr: attr.attributeType in (
        AdminConfigAttribute.optionalAttribute, AdminConfigAttribute.requiredAttribute), self.attributes)
