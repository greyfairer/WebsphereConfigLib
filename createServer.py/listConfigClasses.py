...
class ConfigClasses:
    ...
    ServerConfigClass = AdminConfigClass('Server').withComplex('outputStreamRedirect', AdminConfigClass('StreamRedirect')
    ...
    ApplicationDeploymentClass = AdminConfigClass('ApplicationDeployment').withAttributeList('configs', AdminConfigClass('ApplicationConfig')
    ...
    WebModuleDeploymentClass = AdminConfigClass('Module').withAttributeList('configs', AdminConfigClass('WebModuleConfig')
          .withComplex('sessionManagement', AdminConfigClass('SessionManager')
            .withRequired('enable')
            .withRequired('enableUrlRewriting')
            .withRequired('enableCookies')
